...
<div class="container">
	...
	try
	{
		...
		$narudzbine = $klijent->listaPoslatihNarudzbina();
		echo "<table><thead><th>Datum</th><th>Datum kada je poslato</th><th>Kupac</th><th>Broj mobilnog</th><th>Ukupno</th><th>Detaljnije</th></thead><tbody>";
		foreach($narudzbine as $narudzbina){
			echo "<tr><td>".date("d.m.Y H:i",$narudzbina['datum'])."</td>";
			echo "<td>".date("d.m.Y H:i",$narudzbina['datumP'])."</td>";
